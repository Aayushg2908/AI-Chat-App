...
const availableFeatures = [
  {
    title: "Chat with AI",
    description:
      "Engage in natural conversations with our advanced AI assistants",
    icon: "MessageSquare",
  },
  {
  ...
  },
  {
    title: "Canvas Mode",
    description:
      "Create beautiful UI's with our Canvas Mode and preview them in real-time",
    icon: "Palette",
  },
  {
    title: "Web Search",
    description:
      "AI can search the web for real-time information to answer your questions with the latest data",
    icon: "Globe",
  },
  {
    title: "File Uploads",
    description:
      "Upload documents and files for the AI to analyze, summarize, and extract information from",
    icon: "Upload",
  },
];
...
const comingSoonFeatures = [
  ...
  },
  {
    ...
    description:
      "Let AI manage your schedule and set up meetings intelligently",
    icon: "Calendar",
  },
  {
